...
s3.download_file(Bucket="fraudguard", Key='RAG/index.faiss', Filename=f"{file_path}/my_faiss.faiss")
s3.download_file(Bucket="fraudguard", Key='RAG/index.pkl', Filename=f"{file_path}/my_faiss.pkl")
...
def load_embeddings():
    ...
    s3.download_file(Bucket="fraudguard", Key='train_list.pkl', Filename=f"{file_path}/train_list.pkl")
    s3.download_file(Bucket="fraudguard", Key='train_labels.pkl', Filename=f"{file_path}/train_labels.pkl")
    s3.download_file(Bucket="fraudguard", Key='embeddings_list (1).pkl', Filename=f"{file_path}/embeddings_list.pkl")
